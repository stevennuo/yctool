...
var src = 'mothership', dest = 'yc-course-video';

module.exports = function (qiniu, mongoose) {
    var Video = mongoose.model('Video', {url: String})
...
//        console.log(docs.toString())
        ...
        docs.forEach(function (doc) {
            // TODO:
            var keys = (/^http:\/\/mothership\.qiniudn\.com\/(.*)/g).exec(doc.url);
            ...
            if (key) {
                ...
                doc.url = 'http://'+dest+'.qiniudn.com/' + key
                doc.save();
            }
        });
